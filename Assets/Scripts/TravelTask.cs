...
public class TravelTask : MonoBehaviour
{
    ...
    private float allowTeleportTimer;
    ...
    {
        allowTeleportTimer = GetComponent<CylinderManager>().fieldDiameter / GetComponent<BaseLocomotion>().GetSpeed();
    }
}
